...
function app.TasklistConfig:getAllowedOrigins()
	do return {
		"http://localhost:8080",
		"http://localhost:8081",
		"http://ec2-13-229-46-107.ap-southeast-1.compute.amazonaws.com:30106"
	} end
end
...
function app.TasklistDatabase.Task:setIdValue(value)
	do return self:setId(_g.jk.lang.Integer:asObject(value)) end
end

function app.TasklistDatabase.Task:getIdValue()
...
function app.TasklistDatabase:updateTables()
	...
	do task:addIntegerKeyColumn("id") end
